...
> _**Например: 1)** 123 -> 6 (1 + 2 + 3), **2)** 100 -> 1 (1 + 0 + 0)_
...
> _**Например: 1)** 6 -> 1 4 1, **2)** 24 -> 4 16 4, **3)** 60 -> 10 40 10_
...
> _**Например: 1)** 385916 -> yes, **2)** 123456 -> no_

**Задача 8:** Требуется определить, можно ли от шоколадки размером n
× m долек отломить k долек, если разрешается сделать один разлом по
прямой между дольками (то есть разломить шоколадку на два
прямоугольника).
> _**Например: 1)** 3 2 4 -> yes, **2)** 3 2 1 -> no_
...
> _**Например:** Ввод: ноутбук Вывод: 12_
...
помощью рекурсии.
> _**Например: 1)** A = 3; B = 5 -> 243 (3⁵), **2)** A = 2; B = 3 -> 8_

**Задача 28:** Напишите рекурсивную функцию sum(a, b),
возвращающую сумму двух целых неотрицательных чисел. Из
всех арифметических операций допускаются только +1 и -1.
Также нельзя использовать циклы.
> _**Например:** a=2, b=2 -> 4_
...
в порядке
> _**Например:** Ввод: пара-ра-рам рам-пам-папам па-ра-па-дам Вывод: Парам пам-пам_
...
> _**Например:** Ввод: print_operation_table(lambda x, y: x * y)   
 Вывод:   
 1  2  3  4  5  6    
 2  4  6  8 10 12   
 3  6  9 12 15 18   
...
**Задача 42:** Узнать какая максимальная households в зоне минимального значения populatio
